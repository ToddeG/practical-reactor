...
public class c5_CreatingSequence {
    ...
    public void value_I_already_have_mono() {
        ...
        Mono<String> valueIAlreadyHaveMono = Mono.just("value"); //todo: change this line only
    ...
    public void future_counter() {
        ...
        Mono<Integer> futureCounterMono = Mono.fromCompletionStage(completableFuture); //todo: change this line only
    ...
    public void generate_programmatically() {
        ...
        Flux<Integer> generateFlux = Flux.generate(() -> 0,
                (state, sink) ->  {
                    sink.next(state);
